										...
										<div class=WordSection1>
												...
												<tr style='height: 20.55pt'>
													...
													<td width=574 colspan=11
														...
														<p class=a
															...
															<span
																style='font-family: "Gulim", sans-serif; letter-spacing: .05pt'>&nbsp; ${bstrip.BSTRIPDATE}</span>
														</p>
													</td>
												</tr>
												<tr style='height: 55.8pt'>
													...
													<td width=72
														...
														<p class=a align=center
															style='margin-top: 4.8pt; margin-right: 0in; margin-bottom: .8pt; margin-left: 0in; text-align: center; line-height: normal; word-break: normal'>
															<span lang=ZH-CN D
																style='font-family: "Gulim", sans-serif; letter-spacing: .05pt'>경유지 :<br>${bstrip.BSTRIPSTOPOVER} </span>
														</p>
													</td>
												...
												<tr style='height: 27.0pt'>
													...
													<td width=79 colspan=2
														...
														<p class=a align=center
															style='margin-top: 0in; margin-right: 1.25pt; margin-bottom: 0in; margin-left: 1.25pt; margin-bottom: .0001pt; text-align: center; line-height: normal; word-break: normal'>
															<b><span lang=ZH-CN
																style='font-family: "Gulim", sans-serif; letter-spacing: .05pt'>성명 : ${users.USER_NAME}</span></b>
														</p>
													</td>
                                            ...
                                            <div class="mt-5">
										     ...
										     <div>
										        ...
										        <form action="../edms/updateOpinion" method="post">
