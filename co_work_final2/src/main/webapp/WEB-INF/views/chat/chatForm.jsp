...
<jsp:include page="../main/header.jsp"/>
	...
	#total > div.w-100.user-chat > div > div.w-100.user-chat{
	/* display:none */;
	}
	</style>
                                ...
                                <div class="w-100 user-chat">
                                    ...
                                    <div class="search-box chat-search-box py-4">
                                        <div class="position-relative">
                                            <input type="text" class="form-control" placeholder="이름을 입력하세요" name="search_word" value="${search_word}" }>
                                                            ...
                                                            <a href="javascript: void(0);">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="flex-shrink-0 align-self-center me-3">
																		...
																		<c:if test="${m.user_id == loginid}">
																			<div class="flex-grow-1 overflow-hidden myinfo"> 
																		</c:if>
                                                                        ...
                                                                        <h5 class="text-truncate font-size-14 mb-1" >${m.user_name}, ${m.dept_name }</h5>
